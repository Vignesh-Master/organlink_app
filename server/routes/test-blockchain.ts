...
router.post("/test-attest", async (req: Request, res: Response) => {
  try {
    ...
    const testDocHash = docHash || "0x1234567890123456789012345678901234567890123456789012345678901234";
...
router.post("/test-create-org", async (req: Request, res: Response) => {
  try {
    ...
    const result = await blockchainService.createOrganization(testName, testManager);
